			...
			<div class="cart-collaterals">
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e( 'Coupon', 'woocommerce' ); ?>:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', 'woocommerce' ); ?>" /> <input type="submit" class="button use_code" name="apply_coupon" value="<?php _e( 'Use Code', 'woocommerce' ); ?>" />
