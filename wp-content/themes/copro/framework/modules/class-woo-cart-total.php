	...
	public static function display( $classes = '' ) {
		...
		if( true == is_woocommerce_activated() ) {
			...
			<div class="iv-module woo-cart <?php echo esc_attr($classes); ?> <?php echo esc_attr($cart_layout_class); ?> show-total">
				<div class="centered">
					<a class="cart-contents trigger" href="<?php echo esc_attr($woocommerce->cart->get_cart_url()); ?>">
						<span class="cart-total"><?php echo $woocommerce->cart->get_cart_total(); ?></span>
						<div class="basket-wrapper">
							<div class="top"></div>
							<div class="basket"><span><?php echo intval($woocommerce->cart->cart_contents_count); ?></span></div>
							<div class="header-cart-total"><?php _e('Shopping Cart', 'ivan'); ?> <span class="header-cart-total-value"><?php echo $woocommerce->cart->get_cart_total(); ?></span></div>
						</div>
					</a>
