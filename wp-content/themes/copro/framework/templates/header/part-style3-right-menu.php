...
/**
 *
 * Template Part called at class Ivan_Layout_Header_Style3_Right_Menu
 *
...
<div class="<?php echo apply_filters( 'iv_header_classes', 'iv-layout header simple-right-menu style3-right-menu apply-height '. $_classes ); ?>">
	<div class="container">
		<div class="row">
