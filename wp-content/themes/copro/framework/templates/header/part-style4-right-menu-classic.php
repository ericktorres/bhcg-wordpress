...
/**
 *
 * Template Part called at class Ivan_Layout_Header_Style4_Right_Menu_Classic
 *
...
<div class="<?php echo apply_filters( 'iv_header_classes', 'iv-layout header style4-right-menu classic-style apply-height '. $_classes ); ?>">
	<div class="row">
