...
/**
 *
 * Template Part called at class Ivan_Layout_Header_Style_Right_Area
 *
...
<div class="<?php echo apply_filters( 'iv_header_classes', 'iv-layout header classic-right-area style2-right-area hide-container '. $_classes ); ?>">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 menu-area">
					...
					$menu_args = array(
						...
						'container' => 'div',
						'container_class' => 'light-submenu hidden-xs hidden-sm iv-module-menu menu-wrapper' . ivan_get_option_display( 'header-menu-pull-center-switch', ' centralized-menu', ' pull-left' ),
