...
class Ivan_Layout_Dark_Menu extends Ivan_Layout {

	// Layout slug used as parameters to actions and filters
	public $slug = '_dark_menu';
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'dark-menu') );
