...
class Ivan_Layout_Header_Style2_Right_Area extends Ivan_Layout {

	// Layout slug used as parameters to actions and filters
	public $slug = '_style2_right_area';

	public function return_template_path() {
		return 'style2-right-area';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'style2-right-area') );
