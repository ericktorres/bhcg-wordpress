...
class Ivan_Layout_Header_Style4_Right_Menu_Classic extends Ivan_Layout  {

	// Layout slug used as parameters to actions and filters
	public $slug = '_style4_right_menu_classic';

	public function return_template_path() {
		return 'style4-right-menu-classic';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'style4-right-menu-classic') );
